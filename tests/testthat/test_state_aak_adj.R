...
test_that(
    desc = "AA&K-ADJ matches paper Table 5 on infants data", {
        ...
        expect_equal(
            result$statistics$lower / 100, 0.1163, tolerance = 0.005
        )
        expect_equal(
            result$statistics$upper / 100, 0.1706, tolerance = 0.005
        )
    }
)
...
test_that(
    desc = "AA&K-ADJ matches paper Table 6 on PMI data", {
        ...
        expect_equal(
            result$statistics$lower / 100, 0.3275, tolerance = 0.005
        )
        expect_equal(
            result$statistics$upper / 100, 0.6532, tolerance = 0.005
        )
    }
)
