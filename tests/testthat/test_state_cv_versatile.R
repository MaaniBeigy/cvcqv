...
test_that(
  desc = "for sample sizes higher than 340",
  {
    ...
    expect_equal(
      cv_versatile(
        x,
        digits = 7, method = "mahmoudvand_hassani"
      )$statistics$est,
      37.97088,
      tolerance = 0.01
    )
    expect_equal(
      cv_versatile(
        x,
        digits = 7, method = "mahmoudvand_hassani", correction = TRUE
      )$statistics$est,
      37.95918,
      tolerance = 0.01
    )
    expect_equal(
      cv_versatile(
        x,
        digits = 7, method = "shortest_length"
      )$statistics$lower,
      37.32619,
      tolerance = 0.01
    )
    expect_equal(
      cv_versatile(
        x,
        digits = 7, method = "shortest_length", correction = TRUE
      )$statistics$lower,
      37.31469,
      tolerance = 0.01
    )
